...
// we validate if the  user prevoiusly chose  topic
if (selectedTheme) {
    // if the valdation is fufilled, we ask what the issue was to know if we activated or deactivated the dark themeButton
